...
// Gordian Edenhofer 04.05.14 START
	printf("\n##########Checksum:\n##########checksum=%x=%d\n##########(256-checksum-edid[127])(mod)256=%x=%d\n##########edid[127]=%x=%d\n\n", checksum, checksum, (256-(checksum-edid[127]))%256, (256-(checksum-edid[127]))%256, edid[127], edid[127]);
// Gordian Edenhofer ENDE
...
// Gordian Edenhofer 03.05.14 START
/*
...
*/
printf("\n");
printf("##########X-Aufloesung:dtd[2]=%x=%d, dtd[4]>>4<<8=%x=%d\n", dtd[2], dtd[2], 256*(dtd[4]>>4), 256*(dtd[4]>>4));
printf("##########Y-Aufloesung:dtd[5]=%x=%d, dtd[7]>>4<<8=%x=%d\n", dtd[5], dtd[5], 256*(dtd[7]>>4), 256*(dtd[7]>>4));	
	printf("##########dtd[2]=%x=%d\tdtd[4]=%x=%d\t\tdtd[5]=%x=%d\tdtd[7]=%x=%d\t\n", dtd[2], dtd[2], dtd[4], dtd[4], dtd[5], dtd[5], dtd[7], dtd[7]);
printf("##########Eigene Formel: X-Aufloesung:%d\tY-Aufloesung:%d\n", (dtd[4]/16)*256+dtd[2], (dtd[7]/16)*256+dtd[5]);
printf("\n");
// Gordian Edenhofer ENDE
